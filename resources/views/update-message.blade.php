...
@section('content')
    ...
    <form action="{{ route('contact-update-submit', $data->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" value="{{ $data->email }}" placeholder="Email" id="email" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="message" id="message" placeholder="Введите сообщения" class="form-control">{{ $data->message }}</textarea>
        </div>
